...
TIME_LIMIT = 500  # number of milliseconds before timeout
...
#if the number of moves to the terminal state is small, give that a higher weight than a comparingly similar algorithm